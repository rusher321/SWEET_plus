...
parser.add_argument("-f", type=str , default="./example/expression.txt" , help="expression file")#expression profile
parser.add_argument("-w", type=str , default="./example/weight.txt" , help="weight file")#weight profile
parser.add_argument("-p", type=str , default="./example/patient.txt" , help="patient file")#patient file
parser.add_argument("-g", type=str , default="./example/gene.txt" , help="gene file")#gene file
